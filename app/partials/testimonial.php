<div class="testimonial finger align-items-center">
	<div class="finger__image">
		<img src="<?=HTML_ROOT;?>/assets/images/placeholders/video-placeholder.webp" alt="placeholder" class="card__img">
	</div>
	<div class="finger__text">
		<h4>"They're very hands-on, consistantly demonstrating true partnership and accountability at every level."</h4>
		<p>Kevin Leith<br>
			Gm Marketing &amp; Customer Engagement<br>
			Auckland Transport
		</p>
